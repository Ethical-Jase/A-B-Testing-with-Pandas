...
clicks_pivot[True] / (clicks_pivot[True] +
clicks_pivot[False])
...
a_clicks =\
ad_clicks[ad_clicks.experimental_group == 'A']
b_clicks =\
ad_clicks[ad_clicks.experimental_group == 'B']
...
a_clicks_pivot[True] / (a_clicks_pivot[True] +
...
b_clicks_pivot[True] / (b_clicks_pivot[True] +
